...
public class showluxurydetail extends JFrame {
	...
	public showluxurydetail() {
		...
		JLabel lblLuxuryDoubleRoom = new JLabel("Luxury Double Room");
		...
		JLabel lblChargePerDay = new JLabel("Charge Per Day: 4000");
