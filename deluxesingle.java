...
public class deluxesingle extends JFrame {
	...
	public deluxesingle() {
		...
		JLabel lblLuxuryDoubleRoom = new JLabel("Deluxe Single  Room");
		...
		JLabel lblNoOfDouble = new JLabel("No. Of Double Bed :  1");
		...
		JLabel lblChargePerDay = new JLabel("Charge Per Day: 2000");
